...
public class MergeIncrementalFFSTest {
    ...
    public void test1() throws IOException {
        ...
        try(BufferedWriter baseBW = FlatFileStoreUtils.createWriter(base, Compression.GZIP)) {
        ...
        try(BufferedWriter baseInc = FlatFileStoreUtils.createWriter(inc, Compression.GZIP)) {
        ...
        MergeIncrementalFFS merge = new MergeIncrementalFFS(Collections.emptySet(), base, inc, merged, Compression.GZIP);

        merge.doMerge();

        try(BufferedReader br = FlatFileStoreUtils.createReader(merged, Compression.GZIP)) {
