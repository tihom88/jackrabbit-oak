            ...
            while (baseLine != null || incLine != null) {
                if (baseLine != null && incLine != null) {
                    ...
                    if (compared < 0) {
                        ...
                        if (!(IncrementalOperand.DELETE.toString().equals(operand))) {
                            writer.write(removeOperand(incLine));
                            writer.write("\n");
                        }
                        baseLine = baseFFSBufferedReader.readLine();
                    ...
                    if (incLine == null) {
                        ...
                        if (IncrementalOperand.MODIFY.toString().equals(operand) || IncrementalOperand.DELETE.toString().equals(operand)) {
