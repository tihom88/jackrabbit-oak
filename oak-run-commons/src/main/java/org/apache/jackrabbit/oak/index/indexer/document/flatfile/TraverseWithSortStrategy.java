...
public class TraverseWithSortStrategy implements SortStrategy {
    ...
    public TraverseWithSortStrategy(NodeStateEntryTraverserFactory nodeStatesFactory, PathElementComparator pathComparator,
